...
/**
 * RecyclerTouchListener: Listener cho việc swipe để xóa trong fragment danh sách công thức đã lưu
 * Xem thêm tại: https://medium.com/@velmm/android-recyclerview-with-swipe-menu-example-86259df97907
 * */
public class SaveRecyclerTouchListener implements RecyclerView.OnItemTouchListener, OnActivityTouchListener {
...
//                    vibe.vibrate(100); // do we really need to add vibrate service
    ...
    public SaveRecyclerTouchListener(Activity a, RecyclerView recyclerView) {
        this.act = a;
...
//        mSwipeListener = listener;
    ...
    public SaveRecyclerTouchListener setClickable(OnRowClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
    }

    public SaveRecyclerTouchListener setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public SaveRecyclerTouchListener setLongClickable(boolean vibrate, OnRowLongClickListener listener) {
    ...
    public SaveRecyclerTouchListener setLongClickable(boolean longClickable) {
        this.longClickable = longClickable;
        return this;
    }

    public SaveRecyclerTouchListener setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public SaveRecyclerTouchListener setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<>(Arrays.asList(rows));
        return this;
    }

    public SaveRecyclerTouchListener setIgnoredViewTypes(Integer... viewTypes) {
    ...
    public SaveRecyclerTouchListener setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
    ...
    public SaveRecyclerTouchListener setSwipeable(boolean value) {
    ...
    public SaveRecyclerTouchListener setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public SaveRecyclerTouchListener setUnSwipeableRows(Integer... rows) {
    ...
    public SaveRecyclerTouchListener setViewsToFade(Integer... viewIds) {
        this.fadeViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    // the entire foreground is faded out as it is opened
    public SaveRecyclerTouchListener setFgFade() {
