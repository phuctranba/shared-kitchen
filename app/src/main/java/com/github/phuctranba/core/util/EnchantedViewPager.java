...
/**
 * EchantedViewPager là một ViewPager tùy chỉnh cung cấp một số chức năng tùy chỉnh và hữu ích.
 * Chẳng hạn như Scale, cuộn alpha và vuốt để loại bỏ tùy chọn.
 * Xem thêm tại: https://github.com/TMSantos/echantedviewpager
 * */
